...
def manage_profile(the_type,profile_answer=""):
    ...
    if the_type == "update":
        ...
        elif the_type == "stk2_emt":
            libs.variables.ustkl_config.set("Profile_"+started_at.strftime("%Y%m%d_%H%M%S"), 'name', 'STK 2 Eat My Tyre')
            libs.variables.ustkl_config.set("Profile_"+started_at.strftime("%Y%m%d_%H%M%S"), 'bin_path', the_path+"stk-2-emt/stk-code-emt-fixed/cmake_build/bin/supertuxkart")
            libs.variables.ustkl_config.set("Profile_"+started_at.strftime("%Y%m%d_%H%M%S"), 'data_path', the_path+"stk-2-emt/stk-code-emt-fixed/data/")
            libs.variables.ustkl_config.set("Profile_"+started_at.strftime("%Y%m%d_%H%M%S"), 'type', "git2_emt")
            libs.variables.ustkl_config.set("Profile_"+started_at.strftime("%Y%m%d_%H%M%S"), 'git_path', the_path+"stk-2-emt/stk-code-emt-fixed/")
            libs.variables.ustkl_config.set("Profile_"+started_at.strftime("%Y%m%d_%H%M%S"), 'svn_path', the_path+"stk-2-emt/stk-assets/")
